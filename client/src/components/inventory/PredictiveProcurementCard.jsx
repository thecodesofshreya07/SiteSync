...
export default function PredictiveProcurementCard({ item, onReview, onOpenProcurement }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-teal-200 bg-gradient-to-br from-teal-50 to-white p-5 shadow-card font-public">
      ...
      <h3 className="text-lg font-bold text-slate-900 font-public">{item.item}</h3>
      ...
      <p className="mt-3.5 text-xs font-medium leading-relaxed text-slate-700 font-ibm">
